...
<head>
    ...
    <meta name="keywords" content="masjid, baitul, maal, muslim, pkn, stan">
        <title>Visi dan Misi - MBM PKN STAN</title>
  ...
  <section class="grid3d vertical portfolio" id="portfolio">
    ...
    <div class="container">
		<p style="color:black; text-decoration: none;"><b>Tentang MBM &nbsp;&nbsp; <i class="fa fa-chevron-right"></i> &nbsp;&nbsp; Visi dan Misi</b></p>
    </div>
	
	<div class="container">
		<img class="img-fluid rounded" src="../img/visi.jpg" />
		<br><br>
	    <p>
			<h4>Visi :</h4>
			Visi MBM adalah menjadi lembaga keagamaan yang senantiasa dekat dengan semua civitas akademika kampus, bersahabat bagi semua mahasiswa, dan bermanfaat bagi kampus dan masyarakat.
			
			<br><br>
			
			<h4>Misi :</h4>
			Misi MBM adalah sebagai berikut:
			<ul>
				<li>a. Menyerukan siar Islam secara masif dan efektif;</li>
				<li>b. Mengoptimalkan peran dalam pembentukan karakter islami bagi pengurus dan mahasiswa muslim pada umumnya;</li>
				<li>c. Memaksimalkan peran dalam pelayanan umat; dan</li>
				<li>d. Senantiasa merangkul dan bekerja sama dengan semua elemen mahasiswa dan masyarakat. </li>
			</ul>
