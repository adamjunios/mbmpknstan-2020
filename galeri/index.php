...
<?php
$query=mysqli_query($con,"select id,CategoryName from tblcategory_galeri");
while ($row=mysqli_fetch_array($query)) {
?> 
             <div class="col-sm bottom-space">
					<a style="color:black; text-decoration: none;" href="foto.php?catid=<?php echo htmlentities($row['id'])?>">
						<div class="feature-box">
							<i class="fa fa-image fa-4x fa-icon-image"></i>
