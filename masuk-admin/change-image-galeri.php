...
$query=mysqli_query($con,"update tblposts_galeri set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
$msg="Berhasil";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Ganti Foto</h4>
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostImage,PostTitle from tblposts_galeri where id='$postid' and Is_Active=1 ");
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Foto yang sekarang</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Foto baru</b></h4>
