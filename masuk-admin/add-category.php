...
$status=1;
$query=mysqli_query($con,"insert into tblcategory(CategoryName,Is_Active) values('$category','$status')");
if($query)
{
$msg="Berhasil";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Tambah Kategori-Blog</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Kategori-Blog</a>
                                        </li>
                                        <li class="active">
											Tambah
                                        </li>
