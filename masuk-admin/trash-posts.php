                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Blog Terhapus</h4>
...
<td>
<a href="trash-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=restore" onclick="return confirm('Anda yakin ingin mengembalikan?')"> <i class="ion-arrow-return-right" title="Kembalikan"></i></a>
    &nbsp;
    <a href="trash-posts.php?presid=<?php echo htmlentities($row['postid']);?>&&action=perdel" onclick="return confirm('Anda yakin ingin menghapus?')"><i class="fa fa-trash-o" style="color: #f05050" title="Hapus permanen"></i></a> 
 </td>
 </tr>
<?php } }?>
