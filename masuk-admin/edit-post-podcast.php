...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tblposts_podcast set PostTitle='$posttitle',
PostDetails='$postdetails',
PostUrl='$url',Is_Active='$status' where id='$postid'");
        if ($query) {
            $msg = "Berhasil";
        } else {
            $error = "Gagal";
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <?php
                        $postid = intval($_GET['pid']);
                        $query = mysqli_query($con, "select tblposts_podcast.id as postid,tblposts_podcast.PostImage,tblposts_podcast.PostTitle as title,tblposts_podcast.PostDetails from tblposts_podcast where tblposts_podcast.id='$postid' and tblposts_podcast.Is_Active=1 ");
