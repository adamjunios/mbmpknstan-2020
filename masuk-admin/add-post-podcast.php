...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $status = 1;
            $query = mysqli_query($con, "insert into tblposts_podcast(PostTitle,PostDetails,ust,PostUrl,Is_Active,PostImage) values('$posttitle','$postdetails','$ust','$url','$status','$imgnewfile')");
            if ($query) {
                $msg = "Berhasil";
            } else {
                $error = "Gagal";
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="ust" name="ust" placeholder="Masukkan Nama Pembicara" required>
                                            </div>
                                                        ...
                                                        <div class="">
                                                            <form name="addpost" method="post" enctype="multipart/form-data">
                                                                <div class="form-group m-b-20">
                                                                    ...
                                                                    <input type="text" class="form-control" id="postUrl" name="postUrl" placeholder="Masukkan Link" required>
                                                                </div>
