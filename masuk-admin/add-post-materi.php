...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $url = implode("-", $arr);
        $status = 1;
        $query = mysqli_query($con, "insert into tblposts_materi(PostTitle,PostDetails,PostUrl,Is_Active) values('$posttitle','$postdetails','$url','$status')");
        if ($query) {
            $msg = "Berhasil";
        } else {
            $error = "Gagal";
                                ...
                                <div class="">
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    <h4 class="m-b-30 m-t-0 header-title"><b>Isi Materi (Silakan masukkan link video dengan mengklik ikon video dan masukkan keterangan video di bawahnya.)</b></h4>
