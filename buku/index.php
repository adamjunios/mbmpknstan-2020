...
<?php
$query=mysqli_query($con,"select id,CategoryName from tblcategory_buku");
while ($row=mysqli_fetch_array($query)) {
?> 
             <div class="col-sm bottom-space">
					<a style="color:black; text-decoration: none;" href="buku.php?catid=<?php echo htmlentities($row['id'])?>">
						<div class="feature-box">
							<i class="fa fa-book fa-4x fa-icon-image"></i>
							<h5 class="heading-tertiary u-margin-bottom-small"><?php echo htmlentities($row['CategoryName']);?></h5>
						</div>
					</a>
            </div>
