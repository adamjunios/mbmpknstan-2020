...
<head>
    ...
    <meta name="keywords" content="masjid, baitul, maal, muslim, pkn, stan">
        <title>Hubungi Kami - MBM PKN STAN</title>
  ...
  <nav class="navbar navbar-expand-lg fixed-top activate-menu navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="dropdown">
          <a class="nav-link" style="color:black" href="#"><b>Tentang MBM</b></a>
  ...
  <section class="grid3d vertical portfolio" id="portfolio">
    ...
    <div class="container">
		<p style="color:black; text-decoration: none;"><b>Tentang MBM &nbsp;&nbsp; <i class="fa fa-chevron-right"></i> &nbsp;&nbsp; Hubungi Kami</b></p>
    </div>
	
	<div class="container">
		<img class="img-fluid rounded" src="../img/hubungi.jpg" />
		<br><br>
                <div class="row margin-15px-bottom">
                    ...
                    <div class="col-sm-11">
                        <p class="text-small"><a href="https://instagram.com/mbmpknstan" target="_blank" style="text-decoration: none;"/>@mbmpknstan</a><br>Instagram</p>
                    </div>
                </div>
				...
				<div class="row margin-15px-bottom">
                    <div class="col-sm-1 no-padding">
                        <div class="contact-icon text-blue">
                            <img src="../img/line2.png" width="46px"/>
                        </div>
                    </div>
                    <div class="col-sm-11">
                        <p class="text-small"><a style="text-decoration: none;"  href="https://line.me/R/ti/p/%40mbmpknstan" target="_blank">@mbmpknstan</a><br>LINE Official Account</p>
                    </div>
                </div>
                ...
                <div class="row margin-15px-bottom">
                    ...
                    <div class="col-sm-11">
                        <p class="text-small"><a href="tel:+628118428575" style="text-decoration: none;">08118428575</a><br>Humas (Isham)</p>
                    </div>
                </div>
                ...
                <div class="row margin-15px-bottom">
                    ...
                    <div class="col-sm-11 xs-margin-50px-bottom">
                        <p class="text-small"><a href="mailto:mbm@pknstan.ac.id" target="_blank" style="text-decoration: none;">mbm@pknstan.ac.id</a> <br>E-mail</p>
                    </div>
