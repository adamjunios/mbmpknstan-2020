...
$query=mysqli_query($con,"select tblposts_toko.id as pid,tblposts_toko.PostTitle as posttitle,tblposts_toko.CategoryId as category,tblposts_toko.PostDetails as postdetails,tblposts_toko.PostingDate as postingdate,tblposts_toko.PostUrl as url from tblposts_toko where tblposts_toko.PostTitle like '%$st%' and tblposts_toko.Is_Active=1 LIMIT $offset, $no_of_records_per_page");
